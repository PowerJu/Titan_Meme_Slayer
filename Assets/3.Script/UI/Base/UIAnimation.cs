...
namespace UserInterface
{
    ...
    public class UIAnimation : UIBase
    {
        ...
        [Header("OnStart")] [SerializeField] private List<BehaviorFactoryData> OnStartBehaviorFactoryList;
        private List<BehaviorData> onStartEffectList;

        [Header("OnClick")] [SerializeField] private List<BehaviorFactoryData> OnClickBehaviorFactoryList;
        private List<BehaviorData> onClickEffectList;

        [Header("OnDown")] [SerializeField] private List<BehaviorFactoryData> OnDownBehaviorFactoryList;
        private List<BehaviorData> onDownEffectList;

        [Header("OnUp")] [SerializeField] private List<BehaviorFactoryData> OnUpBehaviorFactoryList;
        private List<BehaviorData> onUpEffectList;

        [Header("OnEnter")] [SerializeField] private List<BehaviorFactoryData> OnEnterBehaviorFactoryList;
        private List<BehaviorData> onEnterEffectList;

        [Header("OnExit")] [SerializeField] private List<BehaviorFactoryData> OnExitBehaviorFactoryList;
        private List<BehaviorData> onExitEffectList;

        [Header("OnOpen")] [SerializeField] private List<BehaviorFactoryData> OnOpenBehaviorFactoryList;
        private List<BehaviorData> onOpenEffectList;

        [Header("OnClose")] [SerializeField] private List<BehaviorFactoryData> OnCloseBehaviorFactoryList;
        private List<BehaviorData> onCloseEffectList;

        [Header("OnTrigger")] [SerializeField] private List<BehaviorFactoryData> OnTriggerBehaviorFactoryList;
        ...
        private List<BehaviorData> InitBehaviorFactoryList(List<BehaviorFactoryData> behaviorFactoryList)
        {
            ...
            foreach (var factory in behaviorFactoryList)
                list.Add(new BehaviorData(factory.animationDuration, factory.BehaviorFactory.CreateBehaviorEffects(),
                    factory.target));
        ...
        private void PlayAnimation(int index, List<BehaviorData> effects, Action callback = null)
        {
            ...
            effects[index].Behavior.BehaviorExecute(effects[index].Target.transform, effects[index].AnimationDuration)
                .OnComplete(() =>
                {
